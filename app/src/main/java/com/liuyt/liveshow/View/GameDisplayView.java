package com.liuyt.liveshow.View;
 ...
 *
 */
public class GameDisplayView extends SurfaceView implements SurfaceHolder.Callback,Camera.PreviewCallback{
    ...
    @SuppressLint("NewApi")
    public GameDisplayView(Context context, int screenWidth, int screenHeight) {
        super(context);
